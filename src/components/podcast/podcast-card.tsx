...
export function PodcastCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-xl border border-gray-200 bg-white transition-all hover:border-gray-300 hover:shadow-md">
      {/* Top gradient bar */}
      ...
      <div className="p-4">
        ...
        <Link href={`/podcast/${id}`}>
          <h3 className="mb-1 line-clamp-2 text-sm font-semibold text-gray-900 group-hover:text-violet-700">
            {title}
          </h3>
        </Link>
